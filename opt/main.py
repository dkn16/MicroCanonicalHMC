...
def sample(m, sampling_alg, L, n):
    ...
    np.savez('/pscratch/sd/d/dkn16/MicroCanonicalHMC/opt/data/'+ m.model.name + '/' + sampling_alg.name + str(L) + '.npz', stepsize= step_size, bias= b, eevpd= eevpd)
...
num_burnin = 10**4
models = [Model(Gaussian(ndims= 100,stochastic_grad = 0.), [2.5, 20.], 0), # [2.5, 14.]
